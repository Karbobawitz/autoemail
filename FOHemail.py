#This is FOHemail.py, a script written to parse the .csv files generated by autoemail.sh
#and return the values needed for mailsmp to send the emails. You will need to customize
#this document with the emails of your workstudy students. See README.txt for full
...
emails.append("mepottenger@davidson.edu")
...
with open('/Users/alkarbo/autoemail/FOHemail.sh', 'a+') as f: #open a file to write some bash code
    for i in range(len(allinfo)): #for each show
        ...
        f.write("alkarbo@davidson.edu < /Users/alkarbo/autoemail/FOHemail{0}.txt\n".format(i)) #specify the content of the email to be a text file
