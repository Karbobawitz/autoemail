#This is TOautoemail.py, a script written to parse the .csv files generated by autoemail.sh
...
with open('/Users/alkarbo/autoemail/TOemail.sh', 'a+') as f: #open a file to write some custom bash code
    for i in range(len(allinfo)): #for each show
        ...
        f.write("alkarbo@davidson.edu < /Users/alkarbo/autoemail/TOemail{0}.txt\n".format(i)) #specifiy the text fo the email as a file 
