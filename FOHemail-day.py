#File: FOHemail-day.py

#Name: Alexander Karbo (Karbo)

#Date: 7/27/18

#Desc: This is FOHemail-day.py, a script written to parse the .csv files generated
...
with open('/Users/alkarbo/autoemail/FOHsignup.csv', 'rb') as f: #open the csv file
    ...
    for i in range(ncols): #for every column
        ...
        if tomorrow == str(data[1][i]): #if the date of a show is tomorrow
