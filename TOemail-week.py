#File: TOemail-week.py

#Name: Alexander Karbo (Karbo)

#Date: 7/27/18

#Desc: This is TOemail-week.py, a script written to parse the .csv files generated by autoemail.sh
#and return the values needed for mailsmp to send the emails. You will need to customize
#this document with the emails of your workstudy students. See README.md for full
#instructions or is all else fails contact the creator of this script: Alexander Karbo at
#alexanderkarbo@gmail.com.

#Usage: autoemail.sh runs this code to parse the TO signup sheet. Other than updating the 
#emails and pathing you shouldn't need to do much with this.
